            ...
            <div className="border-t border-gray-200 bg-white p-4 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.1)]">
                 <div className="w-full max-w-[1400px] mx-auto flex flex-col gap-4">
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-2 text-sm">
                         ...
                         <div className="bg-gray-50 p-2 rounded border border-gray-100"><div className="text-gray-900 text-xs font-bold uppercase">TOTAL EOD SALES</div><div className="text-gray-900 font-bold">₱{calculations.totalSalesRevenue.toLocaleString('en-US', { minimumFractionDigits: 2 })}</div></div>
